    ...
    public partial class _12 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_learnModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_learnModules_learningPaths_LearningPathId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VocabularySets_Vocabularies_VocabularyId",
                        column: x => x.VocabularyId,
                        principalTable: "Vocabularies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
                    LearnModuleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_learnModules_LearnModuleId",
                        column: x => x.LearnModuleId,
                        principalTable: "learnModules",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "VocabularySetItems",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VocabularySetItems", x => new { x.VocabularySetId, x.VocabularyId });
                    table.ForeignKey(
                        name: "FK_VocabularySetItems_Vocabularies_VocabularyId",
                        column: x => x.VocabularyId,
                        principalTable: "Vocabularies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VocabularySetItems_VocabularySets_VocabularySetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AudioPromptUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImagePromptUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LessonId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    VocabularyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GrammarTopicId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_GrammarTopics_GrammarTopicId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Exercises_Vocabularies_VocabularyId",
                        column: x => x.VocabularyId,
                        principalTable: "Vocabularies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinutesStudied = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LessonId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CreatedAt", "DailyGoal", "Email", "EmailConfirmed", "IsActive", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PersonName", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "StreakDays", "TwoFactorEnabled", "UpdatedAt", "UserName" },
                values: new object[] { new Guid("e4eaaaf2-d142-11e1-b3e4-080027620cdd"), 0, "67e8183b-9af2-4048-a697-341b778b1a24", new DateTime(2025, 5, 31, 17, 4, 48, 394, DateTimeKind.Utc).AddTicks(2338), 30, "van23@example.com", true, true, false, null, "VAN23@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAEGpCFDorROXNFUehakVxkSV5Xd7+EXizGdku5SOOM1/aaQlxUIRlTBW2f2+Di7mq7Q==", "", null, false, "cf34bc5c-26da-4cd5-9fa3-07d2458df50a", 0, false, new DateTime(2025, 5, 31, 17, 4, 48, 394, DateTimeKind.Utc).AddTicks(2344), "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_GrammarTopicId",
                table: "Exercises",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_VocabularyId",
                table: "Exercises",
                column: "VocabularyId");

            migrationBuilder.CreateIndex(
                name: "IX_learnModules_LearningPathId",
                table: "learnModules",
                column: "LearningPathId");

            migrationBuilder.CreateIndex(
                name: "IX_Lessons_LearnModuleId",
                table: "Lessons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLearningPaths_UserId",
                table: "UserLearningPaths",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VocabularySetItems_VocabularyId",
                table: "VocabularySetItems",
                column: "VocabularyId");

            migrationBuilder.CreateIndex(
                name: "IX_VocabularySets_VocabularyId",
